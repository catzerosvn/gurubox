<form id="form_Member">
                ...
                <div class="font13" style="margin-bottom: 20px;">
                    ...
                    <div style="float: left;margin-top: 0px;margin-left: 0px;">
                        <select class="textbox" id="txt_searchType" name="txt_searchType" style="height: 29px;">                            
                            ...
                            <option value="MEMBERCODE">ค้นหาจาก Member ID</option>
                        </select>
                    </div>
                   <!--<input type="button" value="ค้นหา" class="button_backend1" style="margin-left: -5px;">-->
                    <div style="float: left;font-size: 13px;width: 70px;height: 20px;margin-left: 0px;" class="button-smalldiv" onclick="doSerachMember();">ค้นหา</div>
                </div>
                <div id="div_showData">
                    <?
                    if ($count <= 0) {
    ...
    <div id="div_editMember" style="display: none;"></div>
    <div id="div_deleteMember" style="display: none;" class="font13" title="ยืนยันการลบ Member ">
        <br><center>กรุณายืนยันการลบ Member</center>
